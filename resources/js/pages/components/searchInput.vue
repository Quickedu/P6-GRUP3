...
<template>
    <div class="relative w-full sm:max-w-md">
        ...
        <input
            ...
            class="w-full rounded-full bg-[#f3f6f7] py-2.5 pr-4 pl-11 text-[#023e8a] placeholder-gray-400 shadow-md focus:ring-2 focus:ring-indigo-500 focus:outline-none"
            @input="handleInput"
            @keyup="handleKeyup"
        />
    </div>
