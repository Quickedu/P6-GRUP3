            ...
            <div class="overflow-x-auto">
                <table class="w-full min-w-160 text-sm">
                    <thead class="bg-[#f0f7f6]">
                        ...
                        >
                            <th class="max-w-20 px-4 py-3">Número</th>
                    ...
                    <tbody class="divide-y divide-[#eaf2f1]">
                        <tr
                            ...
                            v-for="need in visibleItems"
                            :key="need.id"
                        >
                            <td class="min-w-4 px-4 py-3">
                                <span
                    ...
                    <div class="grid grid-cols-6 gap-x-4 gap-y-4">
                        <div class="col-span-3">
                            <label
                                ...
                                >Nom de la necessitat</label
                            >
                            <input
                                id="name"
                                v-model="selectedNeed.name"
                                type="text"
                                name="name"
