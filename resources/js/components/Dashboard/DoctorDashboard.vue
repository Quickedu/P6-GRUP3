...
const programadesCount = computed(() => dates.value.filter((d: DateRecord) => d.estat === 'programada').length)
const urgentCount = computed(() => dates.value.filter((d: DateRecord) => d.urgencia === 'urgent').length)
...
<template>
    ...
    <h1 class="text-pmf-primary font-semibold text-2xl mt-4 mx-6">Cites programades</h1>
